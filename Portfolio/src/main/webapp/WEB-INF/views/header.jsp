...
<div id="wrap">
	<nav class="navbar navbar-dark bg-dark">
		...
		<nav>
		<button type="button" class="btn btn-outline-light" onclick="location='login'">LOGIN</button>
		<button type="button" class="btn btn-outline-light" onclick="location='sign_up'">SIGNUP</button>
		</nav>
		</c:when>
		<c:otherwise>
		<nav>
		    ${loginUser.name}님 반갑습니다.
			<button type="button" class="btn btn-primary" onclick="location='logout'">LOGOUT</button>
			</nav>
